  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Spacer that reserves the sidebar width in the document flow */}
        <div
          style={{
            width: isCollapsedOffcanvas
              ? 0
              : isCollapsedIcon
              ? SIDEBAR_WIDTH_ICON
              : SIDEBAR_WIDTH,
        ...
        <div
          style={{
            width: isCollapsedIcon ? SIDEBAR_WIDTH_ICON : SIDEBAR_WIDTH,
            ...(side === "left"
              ? { left: isCollapsedOffcanvas ? `calc(${SIDEBAR_WIDTH} * -1)` : 0 }
              : { right: isCollapsedOffcanvas ? `calc(${SIDEBAR_WIDTH} * -1)` : 0 }),
